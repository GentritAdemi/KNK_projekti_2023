...
public class PasswordHasher {
    ...
    public static boolean compareSaltedHash(String password, String salt, String saltedHash) {
        String newSaltedHash = generateSaltedHash(password, salt); // Generate the salted hash using the provided password and salt

        return newSaltedHash.equals(saltedHash);
    }
